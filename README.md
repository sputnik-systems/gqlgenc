...
```shell script
go get -u github.com/sputnik-systems/gqlgenc
```
...
[clientgen](https://github.com/sputnik-systems/gqlgenc/tree/master/clientgen) is created based on [modelgen](https://github.com/99designs/gqlgen/tree/master/plugin/modelgen). So if you don't have a modelgen, it may be a mysterious move.
